        ...
        <svg width="166" height="77" viewBox="0 0 166 77" fill="#212121">
            ...
            <g fill="none" fill-rule="evenodd">
                <g transform="translate(1 1)">
                    ...
                    <rect x="-.5" y="-.5" width="165" height="76" rx="4" fill="#1f1f1f"></rect>
                    <path fill="#282828" mask="url(#b)" d="M0 0h164v30H0z"></path>
                    <text mask="url(#b)" font-size="12" fill="#fff"><tspan x="7" y="20">Dark</tspan></text>
                    <path
                        ...
                        mask="url(#b)"
                    ></path>
                    <rect fill="#de4c3a" mask="url(#b)" x="7" y="62" width="26" height="6" rx="1"></rect>
                </g>
                <path
                    *ngIf="isActive"
