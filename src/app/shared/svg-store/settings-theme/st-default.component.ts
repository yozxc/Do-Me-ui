...
@Component({
    ...
    template: `
        <svg width="166" height="77" fill="#db4c3f" class="border_container">
            ...
            <g fill="none" fill-rule="evenodd">
                <g transform="translate(1 1)">
                    ...
                    <path fill="#db4c3f" mask="url(#b)" d="M0 0h164v30H0z"></path>
                    <text mask="url(#b)" font-size="12" fill="#fff"><tspan x="7" y="20">Default</tspan></text>
                    <path
                        ...
                        mask="url(#b)"
                    ></path>
                    <rect fill="#db4c3f" mask="url(#b)" x="7" y="62" width="26" height="6" rx="1"></rect>
                </g>
                <path
                    *ngIf="isActive"
...
export class StDefaultComponent implements OnInit {
