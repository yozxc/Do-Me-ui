...
@Component({
    ...
    template: `
        <svg width="166" height="77" viewBox="0 0 166 77" fill="#f7f7f7">
            ...
            <g fill="none" fill-rule="evenodd">
                <g transform="translate(1 1)">
                    ...
                    <path fill="#f7f7f7" mask="url(#b)" d="M0 0h164v30H0z"></path>
                    <text mask="url(#b)" font-size="12" fill="#202020"><tspan x="7" y="20">Neutral</tspan></text>
                    <path
...
export class StNeutralComponent implements OnInit {
